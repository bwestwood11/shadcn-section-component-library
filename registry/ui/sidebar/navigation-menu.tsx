    ...
    <li key={item.url} className="w-full">
      {item.children ? (
        <button
          ...
          className={
            "flex w-full items-center group gap-4 px-3 py-2.5 hover:bg-primary/80 rounded-md hover:text-primary-foreground"
          }
        >
          <item.icon className="text-foreground/70 group-hover:text-primary-foreground size-6" />
        ...
        <a
          href={item.url}
          className={cn(
            "flex items-center group gap-4 px-3 py-2.5 hover:bg-primary/80 rounded-md hover:text-primary-foreground",
      ...
      before:border-b-foreground/30 before:rounded-bl-[50%] before:border-t-0 before:border-r-0`,
            ...
            >
              <a
                className={cn(
                  "flex ml-4 group items-center gap-4 px-3 h-10 hover:bg-primary rounded-md hover:text-primary-foreground",
                  isMinimized && "ml-0",
                ...
                href={child.url}
              >
                <child.icon className="text-foreground/70 size-5 group-hover:text-primary-foreground" />
